...
Ext.Loader.addClassPathMappings({
  ...
  "PenskeTouch": "app",
  "PenskeTouch.control.CircuitControl": "app/control/circuitControl.js",
  "PenskeTouch.control.CredentialControl": "app/control/credentialControl.js",
  "PenskeTouch.control.EventControl": "app/control/eventControl.js",
  "PenskeTouch.control.EventsControl": "app/control/eventsControl.js",
  "PenskeTouch.control.FooterControl": "app/control/footerControl.js",
  "PenskeTouch.control.HeaderControl": "app/control/headerControl.js",
  "PenskeTouch.control.TabsControl": "app/control/tabsControl.js",
  "PenskeTouch.control.TbdControl": "app/control/tbdControl.js",
  "PenskeTouch.control.TileControl": "app/control/tileControl.js"
});
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "PenskeTouch.control.EventControl": [],
  ...
  "PenskeTouch.view.AdminView": [],
  "PenskeTouch.view.AgendaView": [],
  "PenskeTouch.view.BaseView": [],
  "PenskeTouch.view.DriverView": [],
  "PenskeTouch.view.DriversView": [],
  "PenskeTouch.view.LocalGuideView": [],
  "PenskeTouch.view.MenuView": [],
  "PenskeTouch.view.MenuView2": [],
  "PenskeTouch.view.PenskeView": [],
  "PenskeTouch.view.PhotosView": [],
  "PenskeTouch.view.SponsorsView": [],
  "PenskeTouch.view.StartView": [],
  "PenskeTouch.view.TbdView": []
});
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Ext.viewport.WindowsPhone": [],
  "PenskeTouch.control.CircuitControl": [
    "widget.circuitcontrol"
  ],
  "PenskeTouch.control.CredentialControl": [
    "widget.credentialcontrol"
  ],
  "PenskeTouch.control.EventControl": [
    "widget.eventcontrol"
  ],
  "PenskeTouch.control.EventsControl": [
    "widget.eventscontrol"
  ],
  "PenskeTouch.control.FooterControl": [
    "widget.footercontrol"
  ],
  "PenskeTouch.control.HeaderControl": [
